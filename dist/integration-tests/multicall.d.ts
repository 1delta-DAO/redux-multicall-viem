...
export declare const multicall: {
    ...
    hooks: {
        useMultipleContractSingleData: (chainId: number | undefined, latestBlockNumber: number | undefined, addresses: (string | undefined)[], contractInterface: import("abitype").AbiFunction[], methodName: string, callInputs?: (string | number | BigInt | import("../src/validation").MethodArg[] | undefined)[] | undefined, options?: Partial<import("../src").ListenerOptionsWithGas> | undefined) => import("../src").CallState[];
        useSingleContractMultipleData: (chainId: number | undefined, latestBlockNumber: number | undefined, contract: import("../src").ContractInfo | null | undefined, methodName: string, callInputs: ((string | number | BigInt | import("../src/validation").MethodArg[] | undefined)[] | undefined)[], options?: Partial<import("../src").ListenerOptionsWithGas> | undefined) => import("../src").CallState[];
        useSingleContractWithCallData: (chainId: number | undefined, latestBlockNumber: number | undefined, contract: import("../src").ContractInfo | null | undefined, callDatas: string[], options?: Partial<import("../src").ListenerOptionsWithGas> | undefined) => import("../src").CallState[];
        useSingleCallResult: (chainId: number | undefined, latestBlockNumber: number | undefined, contract: import("../src").ContractInfo | null | undefined, methodName: string, inputs?: (string | number | BigInt | import("../src/validation").MethodArg[] | undefined)[] | undefined, options?: Partial<import("../src").ListenerOptionsWithGas> | undefined) => import("../src").CallState;
